...
function (_PureComponent) {
  ...
  function HeaderLoggedOut() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HeaderLoggedOut)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(HeaderLoggedOut, [{
    ...
    value: function render() {
      ...
      var headerCn = cn('header-logged-out', {
      ...
      return React.createElement("div", {
        ...
        className: "header-logged-out__wordmark",
        href: "/"
      }, React.createElement(LogoWordmark, null)), React.createElement("a", {
        className: "header-logged-out__logo",
        href: "/"
      }, React.createElement(Logo, null))), React.createElement("div", {
        className: "header-logged-out__section"
      }, React.createElement("a", {
        className: "header-logged-out__login-link ".concat(loginModalTriggerCn),
        href: "/#"
      }, "Log In"))));
    }
  }]);
...
export { HeaderLoggedOut as default };